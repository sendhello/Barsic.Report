...
mo:
	...
	msgfmt -c -o data/locales/ru/LC_MESSAGES/BarsicReport2.mo data/locales/po/ru.po
	msgfmt -c -o data/locales/en/LC_MESSAGES/BarsicReport2.mo data/locales/po/en.po
